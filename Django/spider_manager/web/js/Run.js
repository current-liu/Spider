$('section .option li').eq(4).addClass('active');
...
$('aside .list li .main p').text(val);
var run = "运行的爬虫";
var pause = "暂停的爬虫";
var error1 = "出错的爬虫";
var total = "全部的爬虫";
switch (val){
	case run:$('aside .list li .main p').css({'background':'#d4726f'});
		break;
	case pause:$('aside .list li .main p').css({'background':'#6e7d88'});
		break;
	case error1:$('aside .list li .main p').css({'background':'#91bdc2'});
		break;
	case total:$('aside .list li .main p').css({'background':'#e1a894'});
		break;
	default:
		break;
}
